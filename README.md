...
[Back to the Top](https://github.com/mikeroyal/SAP-Guide/blob/main/README.md#table-of-contents)

[SAP](https://www.sap.com/index.html) is one of the world's leading producers of software for the management of business processes, developing solutions that facilitate effective data processing and information flow across organizations.

[SAP Learning Hub](https://www.sap.com/training-certification/education-courses/learning-hub.html)

[SAP Training Shop](https://training.sap.com/)

[SAP Free Training](https://training.sap.com/content/free-training)

[SAP Training and Certification Courses](https://www.sap.com/mena/training-certification.html)

[SAP Courses on Udemy](https://www.udemy.com/topic/sap/)

[SAP Training Courses on Coursera](https://www.coursera.org/courses?query=sap)

[SAP ERP Essential Training Online Class on LinkedIn Learning](https://www.linkedin.com/learning/sap-erp-essential-training)

[SAP Certification Courses on Learning Tree](https://www.learningtree.com/training-directory/sap/)
...
[SAP HANA](https://www.sap.com/products/hana.html) is a high-performance in-memory database that speeds data-driven, real-time decisions and actions. 

[SAP HANA Cloud](https://www.sap.com/products/hana/cloud.html) is a fully managed in-memory cloud database as a service (DBaaS). As the cloud-based data foundation for SAP Business Technology Platform, it integrates data from across the enterprise, enabling faster decisions based on live data.

[SAP IQ](https://www.sap.com/products/sybase-iq-big-data-management.html) is an efficient relational database management system (RDBMS) for SAP Business Technology Platform that provides extreme-scale enterprise data warehousing and Big Data analytics.

[SAP ASE](https://www.sap.com/products/sybase-ase.html) is an relational database management server for SAP Business Technology Platform that provides reliable online transaction processing (OLTP).

[SAP SQL Anywhere](https://www.sap.com/products/sql-anywhere.html) is an Embedded Database for Application Software that enables secure, reliable data management for servers. Where no DBA is available and synchronization for tens of thousands of mobile devices, Internet of Things (IoT) systems, and remote environments.

[SAP Cloud ALM](https://support.sap.com/en/alm/sap-cloud-alm.html) is an application lifecycle management offering for cloud-centric customers. It provides extensive implementation and operations capabilities for cloud solutions. SAP Cloud ALM is included in your cloud subscription with SAP Enterprise Support.

[SAP Master Data Governance](https://www.sap.com/products/master-data-governance.html) is an application consolidates and manages master data across the organization. As the master data management layer of SAP’s Business Technology Platform, it provides a unified, trusted view of master data across domains.

[SAP Data Intelligence](https://www.sap.com/products/data-intelligence.html) is a comprehensive data management solution. As the data orchestration layer of SAP’s Business Technology Platform, it transforms distributed data sprawls into vital data insights, delivering innovation at scale.

[SAP Information Steward](https://www.sap.com/products/data-profiling-steward.html) is a software service that supports data profiling and monitoring and information policy management. As the information governance layer of SAP Business Technology Platform, it can help users anticipate risk and drive better business outcomes.

[SAP Data Quality Management, microservices for location data ](https://www.sap.com/products/data-quality-management.html) is a service that provides accurate and complete location data in your operations, resulting in on-time deliveries and high customer satisfaction.

[SAP PowerDesigner](https://www.sap.com/products/powerdesigner-data-modeling-tools.html) is a servie that builds a blueprint of your current enterprise architecture and visualize the impact of change before it happens with SAP PowerDesigner software. 

[SAP Information Lifecycle Management](https://www.sap.com/products/information-lifecycle-management.html) is a service that manages information through its lifecycle while balancing cost, risk, and compliance.

[SAP Landscape Transformation Replication Server](https://www.sap.com/products/landscape-replication-server.html) is a service that supports real-time replication of data from SAP or third-party systems to SAP HANA to run applications and analyze data quickly.

[SAP Data Services](https://www.sap.com/products/data-services.html) is a service that maximizes the value of all your organization’s structured and unstructured data with exceptional functionalities for data integration, quality, and maintenance.

[SAP Extended Enterprise Content Management by OpenText](https://www.sap.com/products/enterprise-content-management.html) is a service that connects all of your structured data and unstructured content to help you work smarter across your business processes.

[SAP Advanced Data Migration](https://www.sap.com/products/advanced-data-migration-software.html) is a service that works with SAP Data Services software to mitigate the cost overruns and conversion failures common in today’s complex data migrations. It combines technology with the best practices to keep your ongoing data migrations on track, on time, and on budget.

[SAP Master Data Governance, enterprise asset management extension by Utopia](https://www.sap.com/products/master-data-governance-eam.html) is a service that optimizes your enterprise asset productivity with comprehensive master data governance.

[SAP Master Data Governance, retail and fashion management extension by Utopia](https://www.sap.com/products/master-data-governance-fashion-retail.html) is a service that digitalizes and streamlines your retail operations with advanced master data management.

[SAP Data Mapping and Protection by BigID](https://www.sap.com/products/data-mapping-protection.html) is a service that provides actionable insights you can use across your organization by serving protected data with SAP Data Mapping and Protection.

[SAP Asset Information Workbench by Utopia](https://www.sap.com/products/asset-information-workbench.html) is a service that allows you to create a digital replica of your physical assets, processes, and systems to make twinning a reality for your enterprise.

[SAP Extension Suite](https://www.sap.com/products/extension-suite.html) is a service that provides the best path to rapidly build and enhance enterprise applications, processes, and experiences.

[SAP Integration Suite ](https://www.sap.com/products/integration-suite.html) is an enterprise integration platform as a service (EiPaaS) that allows you to connect applications, processes, and people with speed and ease.

[SAP Process Orchestration](https://www.sap.com/products/process-orchestration.html) is a software service that supports custom process applications and integration scenarios. As the process orchestration layer of SAP’s Business Technology Platform, it can help you improve process efficiencies and respond to changing demands.

[SAP Analytics Cloud](https://www.sap.com/products/cloud-analytics.html) is a software solution that combines BI, augmented and predictive analytics, and planning capabilities into one cloud environment. For the analytics layer of SAP’s Business Technology Platform, it supports advanced analytics enterprise-wide.

[SAP BusinessObjects Business Intelligence](https://www.sap.com/products/bi-platform.html) is a centralized suite for data reporting, visualization, and sharing. As the on-premise BI layer for SAP’s Business Technology Platform, it transforms data into useful insights, available anytime, anywhere.

[SAP Crystal](https://www.sap.com/products/crystal-bi.html) is a software solutions service that include analytics and reporting software solutions for  small and midsize businesses. The different products enable deeper insights into business information and can help you position your organization for a greater competitive advantage.

[SAP Data Warehouse Cloud](https://www.sap.com/products/data-warehouse-cloud.html) is a cloud data warehouse software that provides unified data and analytics capabilities that power SAP Business Technology Platform, enabling you to connect, transform, model, and visualize your data and gain real-time insights.

[SAP BW/4HANA](https://www.sap.com/products/bw4hana-data-warehousing.html) is a packaged data warehouse based on SAP HANA. As the on-premise data warehouse layer of SAP’s Business Technology Platform, it allows you to consolidate data across the enterprise to get a consistent, agreed-upon view of your data.

[SAP Business Planning and Consolidation](https://www.sap.com/products/bpc.html) is a service that helps improve decision-making, collaboration, and efficiencies with streamlined planning and consolidation.

[SAP Intelligent Robotic Process Automation](https://www.sap.com/products/robotic-process-automation.html) is a service that uses intelligent bots to automate repetitive manual processes. As the robotic process automation layer of SAP’s Business Technology Platform, it can redirect resources to high-value activities and processes.

[SAP Conversational AI](https://www.sap.com/products/conversational-ai.html) is a service that helps users efficiently manage business tasks. As the conversational AI layer of SAP’s Business Technology Platform, it enables users to build and monitor intelligent chatbots in one interface to automate tasks and workflows.

[SAP Internet of Things](https://www.sap.com/products/iot-data-services.html) is a software solution that offers capabilities to address industrial IoT use cases. As the IoT layer of SAP’s Business Technology Platform, it enables users to reimagine business processes and models with embedded IoT services and data. 

[SAP Edge Services](https://www.sap.com/products/edge-services.html) is a set of services that enables powerful microservices to be deployed at the edge and orchestrated from the cloud to extend the processing power of the cloud to the edge.

# SAP DevOps Tools Integration
...
**[SAP Cloud SDK for Java](https://sap.github.io/cloud-sdk/docs/java/overview-cloud-sdk-for-java)**
...
**[SAP Cloud SDK for JavaScript(Node.js)](https://sap.github.io/cloud-sdk/docs/js/overview-cloud-sdk-for-javascript)**
...
**[SAP Cloud SDK for TypeScript](https://sap.github.io/cloud-sdk/docs/js/overview-cloud-sdk-for-javascript)**
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/SAP-Guide/pulls).
